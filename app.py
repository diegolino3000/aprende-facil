...
if not st.session_state.logged_in:
    ...
    with col2:
        ...
        st.subheader("Bienvenido a la App Educativa")
        ...
        with tab2:
            ...
            if st.button("Registrarse", type="primary"):
                if new_user and new_pass:
                    ...
                    st.success(f"¡Cuenta creada correctamente!")
                    st.rerun()
                else:
    ...
    # ==================== BARRA SUPERIOR ====================
    st.title(f"📚 Aprende Matemáticas - Bienvenido {st.session_state.username}")
    ...
    if not st.session_state.grade:
        ...
        st.session_state.age = st.number_input("¿Cuántos años tienes?", min_value=8, max_value=13, value=10)
        ...
        if st.session_state.current_level:
            ...
            st.header(f"✍️ Evaluación: {seccion_actual} - Nivel {nivel_actual}")
            ...
            respuesta = st.radio("Elige la respuesta correcta:", p["o"], key="respuesta")
